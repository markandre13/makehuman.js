...
class DownloadAssetsGit:
    ...
    # /Users/mark/upstream/makehuman/makehuman/data (used)
    _makehuman_data_directory = os.path.abspath(os.path.realpath(getpath.getSysDataPath()))

    # /Users/mark/Documents/MakeHuman/v1py3 (tmp)
    _user_dir = None
    # /Users/mark/Documents/MakeHuman/v1py3/data (tmp)
    _user_data_dir = None

    # /Users/mark/Documents/MakeHuman/v1py3/official_assets
