...
export abstract class FlatMesh {
    ...
    abstract bind(shader: ShaderMono | ShaderShadedMono | ShaderShadedTextured): void
    abstract update(): void
    abstract draw(gl: WebGL2RenderingContext): void
    abstract findVertex(pos: vec2, canvas: HTMLCanvasElement, modelViewMatrix: mat4): number | undefined 
    abstract getVec4(vertexIdx: number): vec4
    abstract get indices(): IndexBuffer
    abstract get vertices(): VertexBuffer
}
