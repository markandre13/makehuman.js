...
describe("chordata", function () {
    ...
    it("decodeRaw()", function () {
        ...
        const e = new Map<string, number[]>([
            ...
            ["/%/r-lowerleg", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/r-upperleg", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/l-foot", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/l-lowerleg", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/l-upperleg", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/r-hand", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/r-lowerarm", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/r-upperarm", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/l-hand", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/l-lowerarm", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/l-upperarm", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/neck", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/dorsal", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
            ["/%/base", [5, 125, 590, 1, 54, 34, 654, 453, 231]],
        ])
        expect(bones).to.deep.almost.equal(e)
    })
...
// /notochord/init
const message0 = `23 62 75 6e 64 6c 65 00 00 00 00 00 00 90 c4 46 #bundle........F
...
// /pose/connect
const message1 = `23 62 75 6e 64 6c 65 00 00 00 00 00 05 30 80 20 #bundle......0.
00 00 00 18 2f 25 25 2f 43 68 6f 72 64 61 74 61 ..../%%/Chordata
2f 72 61 77 00 00 00 00 2c 4e 00 00 00 00 00 3c /raw....,N.....<
2f 25 2f 72 2d 66 6f 6f 74 00 00 00 2c 69 69 69 /%/r-foot...,iii
69 69 69 69 69 69 00 00 00 00 00 05 00 00 00 7d iiiiii.........}
00 00 02 4e 00 00 00 01 00 00 00 36 00 00 00 22 ...N.......6..."
00 00 02 8e 00 00 01 c5 00 00 00 e7 00 00 00 40 ...............@
2f 25 2f 72 2d 6c 6f 77 65 72 6c 65 67 00 00 00 /%/r-lowerleg...
2c 69 69 69 69 69 69 69 69 69 00 00 00 00 00 05 ,iiiiiiiii......
00 00 00 7d 00 00 02 4e 00 00 00 01 00 00 00 36 ...}...N.......6
00 00 00 22 00 00 02 8e 00 00 01 c5 00 00 00 e7 ..."............
00 00 00 40 2f 25 2f 72 2d 75 70 70 65 72 6c 65 ...@/%/r-upperle
67 00 00 00 2c 69 69 69 69 69 69 69 69 69 00 00 g...,iiiiiiiii..
00 00 00 05 00 00 00 7d 00 00 02 4e 00 00 00 01 .......}...N....
00 00 00 36 00 00 00 22 00 00 02 8e 00 00 01 c5 ...6..."........
00 00 00 e7 00 00 00 3c 2f 25 2f 6c 2d 66 6f 6f .......</%/l-foo
74 00 00 00 2c 69 69 69 69 69 69 69 69 69 00 00 t...,iiiiiiiii..
00 00 00 05 00 00 00 7d 00 00 02 4e 00 00 00 01 .......}...N....
00 00 00 36 00 00 00 22 00 00 02 8e 00 00 01 c5 ...6..."........
00 00 00 e7 00 00 00 40 2f 25 2f 6c 2d 6c 6f 77 .......@/%/l-low
65 72 6c 65 67 00 00 00 2c 69 69 69 69 69 69 69 erleg...,iiiiiii
69 69 00 00 00 00 00 05 00 00 00 7d 00 00 02 4e ii.........}...N
00 00 00 01 00 00 00 36 00 00 00 22 00 00 02 8e .......6..."....
00 00 01 c5 00 00 00 e7 00 00 00 40 2f 25 2f 6c ...........@/%/l
2d 75 70 70 65 72 6c 65 67 00 00 00 2c 69 69 69 -upperleg...,iii
69 69 69 69 69 69 00 00 00 00 00 05 00 00 00 7d iiiiii.........}
00 00 02 4e 00 00 00 01 00 00 00 36 00 00 00 22 ...N.......6..."
00 00 02 8e 00 00 01 c5 00 00 00 e7 00 00 00 3c ...............<
2f 25 2f 72 2d 68 61 6e 64 00 00 00 2c 69 69 69 /%/r-hand...,iii
69 69 69 69 69 69 00 00 00 00 00 05 00 00 00 7d iiiiii.........}
00 00 02 4e 00 00 00 01 00 00 00 36 00 00 00 22 ...N.......6..."
00 00 02 8e 00 00 01 c5 00 00 00 e7 00 00 00 40 ...............@
2f 25 2f 72 2d 6c 6f 77 65 72 61 72 6d 00 00 00 /%/r-lowerarm...
2c 69 69 69 69 69 69 69 69 69 00 00 00 00 00 05 ,iiiiiiiii......
00 00 00 7d 00 00 02 4e 00 00 00 01 00 00 00 36 ...}...N.......6
00 00 00 22 00 00 02 8e 00 00 01 c5 00 00 00 e7 ..."............
00 00 00 40 2f 25 2f 72 2d 75 70 70 65 72 61 72 ...@/%/r-upperar
6d 00 00 00 2c 69 69 69 69 69 69 69 69 69 00 00 m...,iiiiiiiii..
00 00 00 05 00 00 00 7d 00 00 02 4e 00 00 00 01 .......}...N....
00 00 00 36 00 00 00 22 00 00 02 8e 00 00 01 c5 ...6..."........
00 00 00 e7 00 00 00 3c 2f 25 2f 6c 2d 68 61 6e .......</%/l-han
64 00 00 00 2c 69 69 69 69 69 69 69 69 69 00 00 d...,iiiiiiiii..
00 00 00 05 00 00 00 7d 00 00 02 4e 00 00 00 01 .......}...N....
00 00 00 36 00 00 00 22 00 00 02 8e 00 00 01 c5 ...6..."........
00 00 00 e7 00 00 00 40 2f 25 2f 6c 2d 6c 6f 77 .......@/%/l-low
65 72 61 72 6d 00 00 00 2c 69 69 69 69 69 69 69 erarm...,iiiiiii
69 69 00 00 00 00 00 05 00 00 00 7d 00 00 02 4e ii.........}...N
00 00 00 01 00 00 00 36 00 00 00 22 00 00 02 8e .......6..."....
00 00 01 c5 00 00 00 e7 00 00 00 40 2f 25 2f 6c ...........@/%/l
2d 75 70 70 65 72 61 72 6d 00 00 00 2c 69 69 69 -upperarm...,iii
69 69 69 69 69 69 00 00 00 00 00 05 00 00 00 7d iiiiii.........}
00 00 02 4e 00 00 00 01 00 00 00 36 00 00 00 22 ...N.......6..."
00 00 02 8e 00 00 01 c5 00 00 00 e7 00 00 00 38 ...............8
2f 25 2f 6e 65 63 6b 00 2c 69 69 69 69 69 69 69 /%/neck.,iiiiiii
69 69 00 00 00 00 00 05 00 00 00 7d 00 00 02 4e ii.........}...N
00 00 00 01 00 00 00 36 00 00 00 22 00 00 02 8e .......6..."....
00 00 01 c5 00 00 00 e7 00 00 00 3c 2f 25 2f 64 ...........</%/d
6f 72 73 61 6c 00 00 00 2c 69 69 69 69 69 69 69 orsal...,iiiiiii
69 69 00 00 00 00 00 05 00 00 00 7d 00 00 02 4e ii.........}...N
00 00 00 01 00 00 00 36 00 00 00 22 00 00 02 8e .......6..."....
00 00 01 c5 00 00 00 e7 00 00 00 38 2f 25 2f 62 ...........8/%/b
61 73 65 00 2c 69 69 69 69 69 69 69 69 69 00 00 ase.,iiiiiiiii..
00 00 00 05 00 00 00 7d 00 00 02 4e 00 00 00 01 .......}...N....
00 00 00 36 00 00 00 22 00 00 02 8e 00 00 01 c5 ...6..."........
00 00 00 e7                                     ....`
